...
namespace Andrei15193.DtoMin
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DtoMinEditorFactoryId)]
	internal partial class DtoMinEditorFactory : DtoMinEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DtoMinEditorFactory.
		/// </summary>
		public DtoMinEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DtoMinEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DtoMinEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new DtoMinDocData(this.ServiceProvider, typeof(DtoMinEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DtoMinDocView(docData, this.ServiceProvider);
		}
	}
}
