...
namespace Andrei15193.DtoMin
{
	...
	/// </summary>
	internal partial class DtoMinCommandSet : DtoMinCommandSetBase
	{
		/// <summary>
		/// Constructs a new DtoMinCommandSet.
		/// </summary>
		public DtoMinCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DtoMinCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DtoMinCommandSetBase.
		/// </summary>
		protected DtoMinCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDtoMinExplorerCommand,
				typeof(DtoMinEditorFactory).GUID);
		...
		{
			DtoMinExplorerToolWindow explorer = this.DtoMinExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DtoMinDocData CurrentDtoMinDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DtoMinDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DtoMinDocView CurrentDtoMinDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DtoMinDocView;
			}
		}
		...
		/// </summary>
		protected DtoMinExplorerToolWindow DtoMinExplorerToolWindow
		{
			get
			{
				DtoMinExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DtoMinExplorerToolWindow), true) as DtoMinExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DtoMinExplorerToolWindow explorerWindow = this.DtoMinExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DtoMinClipboardCommandSet : DtoMinClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DtoMinClipboardCommandSet.
		/// </summary>
		public DtoMinClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DtoMinClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DtoMinClipboardCommandSetBase.
		/// </summary>
		protected DtoMinClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
