...
namespace Andrei15193.DtoMin
{
	...
	/// </summary>
	internal partial class DtoMinExplorer : DtoMinExplorerBase
	{
		/// <summary>
		/// Constructs a new DtoMinExplorer.
		/// </summary>
		public DtoMinExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the DtoMinExplorerToolWindow.
	/// </summary>
	internal abstract class DtoMinExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new DtoMinExplorerBase.
		/// </summary>
		protected DtoMinExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.DtoMinExplorerMenu;
			}
		}
		...
		{
			get { return global::Andrei15193.DtoMin.DTOMap.DomainClassId; }
		}
