...
namespace Andrei15193.DtoMin
{
	...
	/// </summary>
	internal partial class DtoMinDocView : DtoMinDocViewBase
	{
		/// <summary>
		/// Constructs a new DtoMinDocView.
		/// </summary>
		public DtoMinDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DtoMinDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DtoMinDocView.
		/// </summary>
		protected DtoMinDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DtoMinDocDataBase docData = this.DocData as DtoMinDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DtoMinDocViewBase should be an DtoMinDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Andrei15193.DtoMin.DtoMinDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Andrei15193.DtoMin.DtoMinDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Andrei15193.DtoMin.DtoMinToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Andrei15193.DtoMin.DtoMinToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DtoMinDiagramMenu;
			}
		}
			...
			if(global::Andrei15193.DtoMin.DtoMinHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Andrei15193.DtoMin.DtoMinHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
