...
namespace Andrei15193.DtoMin
{
	...
	partial class DtoMinDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			...
			DtoMinSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
	
	
	/// <summary>
	/// Helper class for serializing and deserializing DtoMin models.
	/// </summary>
	public abstract partial class DtoMinSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected DtoMinSerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			DslModeling::IMonikerResolver monikerResolver = store.FindMonikerResolver(DtoMinDomainModel.DomainModelId);
			if (monikerResolver == null)
			{
				monikerResolver = new DtoMinSerializationBehaviorMonikerResolver(store, directory);
				store.AddMonikerResolver(DtoMinDomainModel.DomainModelId, monikerResolver);
			}
			
			// Add serialization behaviors
			directory.AddBehavior(DtoMinSerializationBehavior.Instance);
		}
	...
	/// Helper class for serializing and deserializing DtoMin models.
	/// </summary>
	public sealed partial class DtoMinSerializationHelper : DtoMinSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private DtoMinSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static DtoMinSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static DtoMinSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (DtoMinSerializationHelper.instance == null)
					DtoMinSerializationHelper.instance = new DtoMinSerializationHelper();
				return DtoMinSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace Andrei15193.DtoMin
{
	...
	partial class DtoMinSerializationHelperBase
	{
	
		/// <summary>
		/// Loads a DTOMap instance into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new DTOMap instance will be created into the default partition of this store.</param>
		...
		public virtual DTOMap LoadModel(DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a DTOMap instance into the default partition of the given store.
		/// </summary>
		...
		/// </param>
		/// <returns>The loaded DTOMap instance.</returns>
		public virtual DTOMap LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		public virtual DTOMap LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			...
			{
				throw new global::System.InvalidOperationException(DtoMinDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			
			DTOMap modelRoot = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(partition.Store);
			DslModeling::DomainClassXmlSerializer modelRootSerializer = directory.GetSerializer(DTOMap.DomainClassId);
			global::System.Diagnostics.Debug.Assert(modelRootSerializer != null, "Cannot find serializer for DTOMap!");
				...
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					...
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true, transactionContext))
					{
						...
						if (fileStream.Length > 5)
						{
							try
							{
								global::System.Xml.XmlReaderSettings settings = DtoMinSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
								using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
								{
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as DTOMap;
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, DTOMap modelRoot, string fileName)
		{
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, DTOMap modelRoot, string fileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, DTOMap modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="encoding">Encoding to use when saving the DTOMap instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized DTOMap instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		internal global::System.IO.MemoryStream InternalSaveModel(DslModeling::SerializationResult serializationResult, DTOMap modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			...
			global::System.Xml.XmlWriterSettings settings = DtoMinSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized DtoMinDiagram instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		internal global::System.IO.MemoryStream InternalSaveDiagram(DslModeling::SerializationResult serializationResult, DtoMinDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationResult != null);
			...
			// MonikerResolver shouldn't be required in Save operation, so not calling SetupMonikerResolver() here.
			serializationContext.WriteOptionalPropertiesWithDefaultValue = writeOptionalPropertiesWithDefaultValue;
			global::System.Xml.XmlWriterSettings settings = DtoMinSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, true, encoding);
			using (global::System.Xml.XmlWriter writer = global::System.Xml.XmlWriter.Create(newFileContent, settings))
			{
		...
		/// <summary>
		/// Helper method to create and initialize a new DTOMap.
		/// </summary>
		internal protected virtual DTOMap CreateModelHelper(DslModeling::Partition modelPartition)
		{
			DTOMap model = new DTOMap(modelPartition);
			return model;
		}
		
		/// <summary>
		/// Loads a DTOMap instance and its associated diagram file into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new DTOMap instance will be created into the default partition of this store.</param>
		...
		/// </param>
		/// <returns>The loaded DTOMap instance.</returns>
		public virtual DTOMap LoadModelAndDiagram(DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
		...
		/// <summary>
		/// Loads a DTOMap instance and its associated diagram file into the default partition of the given store.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="store">The new DTOMap instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the DTOMap instance will be deserialized.</param>
		...
		public virtual DTOMap LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Partition modelPartition, string modelFileName, DslModeling::Partition diagramPartition, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			...
			DtoMinDiagram diagram = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(diagramPartition.Store);
			DslModeling::DomainClassXmlSerializer diagramSerializer = directory.GetSerializer(DtoMinDiagram.DomainClassId);
			global::System.Diagnostics.Debug.Assert(diagramSerializer != null, "Cannot find serializer for DtoMinDiagram");
						...
						using (DslModeling::Transaction t = diagramPartition.Store.TransactionManager.BeginTransaction("LoadDiagram", true, transactionContext))
						{
							...
							if (fileStream.Length > 5)
							{
								...
								try
								{
									...
									{
										reader.MoveToContent();
										diagram = diagramSerializer.TryCreateInstance(serializationContext, reader, diagramPartition) as DtoMinDiagram;
										if (diagram != null)
										{
		...
		/// <summary>
		/// Helper method to create and initialize a new DtoMinDiagram.
		/// </summary>
		...
		internal protected virtual DtoMinDiagram CreateDiagramHelper(DslModeling::Partition diagramPartition, DslModeling::ModelElement modelRoot)
		{
			DtoMinDiagram diagram = new DtoMinDiagram(diagramPartition);
			return diagram;
		}
		...
		/// <param name="diagram">DtoMinDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, DTOMap modelRoot, string modelFileName, DtoMinDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, DTOMap modelRoot, string modelFileName, DtoMinDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, DTOMap modelRoot, string modelFileName, DtoMinDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="diagram">DtoMinDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, DtoMinDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, DtoMinDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given DtoMinDiagram to the given file, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">DtoMinDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, DtoMinDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlWriter writer)
		{
			...
			if (!(rootElement is DslDiagrams::Diagram))
			{
				...
				rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/DtoMin";
			}
		...
		protected virtual void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						DtoMinSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					DtoMinSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		protected virtual global::System.Xml.XmlReader TryCreateValidatingReader(DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (success && schemaSet.Count > 0)
			{
				...
				DtoMinSerializationBehaviorSchemaValidationCallback validationCallback = new DtoMinSerializationBehaviorSchemaValidationCallback(serializationContext);
		...
		protected static bool ResolveSchema(string targetNamespace, global::System.Xml.Schema.XmlSchemaSet schemaSet, DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (schemas != null && schemas.Count > 0)
			{
				if (schemas.Count > 1)
				{
					DtoMinSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
				}
				schemaSet.Add(targetNamespace, schemas[0]);
				return true;
			}
	
			DtoMinSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
			return false;
		}
		...
		/// </summary>
		private sealed class DtoMinSerializationBehaviorSchemaValidationCallback
		{
			...
			internal DtoMinSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					DtoMinSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public virtual string GetSerializedModelString(global::Andrei15193.DtoMin.DTOMap modelRoot, global::System.Text.Encoding encoding)
		{
...
namespace Andrei15193.DtoMin
{
	...
	public partial class DTOMap
	{
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = DtoMinSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									DtoMinDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
