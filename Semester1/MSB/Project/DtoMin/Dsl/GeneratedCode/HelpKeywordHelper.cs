...
namespace Andrei15193.DtoMin
{
	...
	/// </remarks>
	public partial class DtoMinHelpKeywordHelper : DtoMinHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DtoMinHelpKeywordHelper.
		/// </summary>
		protected DtoMinHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DtoMinHelpKeywordHelper.
		/// </summary>
		public static DtoMinHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DtoMinHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DtoMinHelpKeywordHelperBase.
		/// </summary>
		protected DtoMinHelpKeywordHelperBase()
			: base() { }
