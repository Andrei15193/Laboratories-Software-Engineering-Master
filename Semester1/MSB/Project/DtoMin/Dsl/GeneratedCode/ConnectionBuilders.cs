...
namespace Andrei15193.DtoMin
{
	...
	/// </summary>
	public static partial class DTOReferencesDTOsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Andrei15193.DtoMin.DTO)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Andrei15193.DtoMin.DTO)
				{
					if (candidateTarget is global::Andrei15193.DtoMin.DTO)
					{
						global::Andrei15193.DtoMin.DTO sourceDTO = (global::Andrei15193.DtoMin.DTO)candidateSource;
						global::Andrei15193.DtoMin.DTO targetDTO = (global::Andrei15193.DtoMin.DTO)candidateTarget;
						if(targetDTO == null || global::Andrei15193.DtoMin.DTOReferencesDTOs.GetLinkToParent(targetDTO) != null) return false;
						if(targetDTO == null || sourceDTO == null || global::Andrei15193.DtoMin.DTOReferencesDTOs.GetLinks(sourceDTO, targetDTO).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Andrei15193.DtoMin.DTO)
				{
					if (target is global::Andrei15193.DtoMin.DTO)
					{
						global::Andrei15193.DtoMin.DTO sourceAccepted = (global::Andrei15193.DtoMin.DTO)source;
						global::Andrei15193.DtoMin.DTO targetAccepted = (global::Andrei15193.DtoMin.DTO)target;
						DslModeling::ElementLink result = new global::Andrei15193.DtoMin.DTOReferencesDTOs(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class DTORelationshipConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new DTORelationshipConnectAction for the given Diagram.
		/// </summary>
		public DTORelationshipConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the DTORelationshipConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new DTORelationshipConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class DTORelationshipConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the DTORelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected DTORelationshipConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder DTOReferencesDTOsBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return DTOReferencesDTOsBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return DTOReferencesDTOsBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				DTOReferencesDTOsBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class DTORelationshipConnectionType : DTORelationshipConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the DTORelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			public DTORelationshipConnectionType() : base() {}
		}
	}
}
