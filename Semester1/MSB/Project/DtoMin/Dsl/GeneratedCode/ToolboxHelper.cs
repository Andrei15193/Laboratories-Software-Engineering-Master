...
namespace Andrei15193.DtoMin
{
	...
	/// </remarks>
	public partial class DtoMinToolboxHelper : DtoMinToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new DtoMinToolboxHelper.
		/// </summary>
		public DtoMinToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class DtoMinToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify DtoMin toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "DtoMin.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify DTORelationship connector tool.
		/// </summary>
		public const string DTORelationshipFilterString = "DTORelationship.1.0";
		...
		/// <summary>
		/// Constructs a new DtoMinToolboxHelperBase.
		/// </summary>
		protected DtoMinToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Andrei15193.DtoMin.DtoMinDomainModel.SingletonResourceManager.GetString("DtoMinToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "Andrei15193.DtoMin.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Andrei15193.DtoMin.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Andrei15193.DtoMin.DtoMinToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DtoMinToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Andrei15193.DtoMin.DTO.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Andrei15193.DtoMin.DTORelationshipToolboxItem":

					// Add DTORelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Andrei15193.DtoMin.DTORelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("DTORelationshipToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("DTORelationshipToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Andrei15193.DtoMin.DtoMinToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DtoMinToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"ConnectExampleRelationF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("DTORelationshipToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(DTORelationshipFilterString)
						});
					break;
				default:
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Andrei15193.DtoMin.DtoMinDomainModel));
