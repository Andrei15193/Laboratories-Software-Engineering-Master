...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "Andrei15193.DtoMin.DtoMinDiagram")]

namespace Andrei15193.DtoMin
{
	/// <summary>
	/// DomainClass DtoMinDiagram
	/// Description for Andrei15193.DtoMin.DtoMinDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("Andrei15193.DtoMin.DtoMinDiagram.DisplayName", typeof(global::Andrei15193.DtoMin.DtoMinDomainModel), "Andrei15193.DtoMin.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("Andrei15193.DtoMin.DtoMinDiagram.Description", typeof(global::Andrei15193.DtoMin.DtoMinDomainModel), "Andrei15193.DtoMin.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::Andrei15193.DtoMin.DtoMinDomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("9b1605d3-4bff-42ed-91e5-e993b5e510bb")]
	public partial class DtoMinDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::Andrei15193.DtoMin.DtoMinToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::Andrei15193.DtoMin.DTO)
			{
				global::Andrei15193.DtoMin.DTOCompartmentShape newShape = new global::Andrei15193.DtoMin.DTOCompartmentShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Andrei15193.DtoMin.DTOReferencesDTOs)
			{
				global::Andrei15193.DtoMin.ExampleConnector newShape = new global::Andrei15193.DtoMin.ExampleConnector(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::Andrei15193.DtoMin.DTOCompartmentShape.DecoratorsInitialized += DTOCompartmentShapeDecoratorMap.OnDecoratorsInitialized;
		}
		
		/// <summary>
		/// Class containing decorator path traversal methods for DTOCompartmentShape.
		/// </summary>
		internal static partial class DTOCompartmentShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for DTOCompartmentShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::Andrei15193.DtoMin.DTO.NameDomainPropertyId);
		...
		private global::Andrei15193.DtoMin.DTORelationshipConnectAction dTORelationshipConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::Andrei15193.DtoMin.DtoMinToolboxHelper.DTORelationshipFilterString))
				{
					if (this.dTORelationshipConnectAction == null)
					{
						this.dTORelationshipConnectAction = new global::Andrei15193.DtoMin.DTORelationshipConnectAction(this);
						this.dTORelationshipConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.dTORelationshipConnectAction;
				} 
				else
				{
					action = null;
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				if(disposing)
				{
					if(this.dTORelationshipConnectAction != null)
					{
						this.dTORelationshipConnectAction.Dispose();
						this.dTORelationshipConnectAction = null;
					}
		...
		/// <summary>
		/// DtoMinDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0x9b1605d3, 0x4bff, 0x42ed, 0x91, 0xe5, 0xe9, 0x93, 0xb5, 0xe5, 0x10, 0xbb);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public DtoMinDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public DtoMinDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace Andrei15193.DtoMin
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::Andrei15193.DtoMin.DTO), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::Andrei15193.DtoMin.DTOReferencesDTOs), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::Andrei15193.DtoMin.DTO)
				{
					parentElement = GetParentForDTO((global::Andrei15193.DtoMin.DTO)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::Andrei15193.DtoMin.DTOMap GetParentForDTO( global::Andrei15193.DtoMin.DTO root )
			{
				// Segments 0 and 1
				global::Andrei15193.DtoMin.DTOMap result = root.DTOMap;
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::Andrei15193.DtoMin.DTOHasAttributes), FireTime=DslModeling::TimeToFire.TopLevelCommit, InitiallyDisabled=true)]
		internal sealed class CompartmentItemAddRule : DslModeling::AddRule
		{
			...
			internal static void ElementAdded(DslModeling::ElementAddedEventArgs e, bool repaintOnly)
			{
				...
				if (e.ModelElement.IsDeleted)
					return;
				if(e.ModelElement is global::Andrei15193.DtoMin.DTOHasAttributes)
				{
					global::System.Collections.IEnumerable elements = GetDTOForDTOCompartmentShapeAttributesCompartment((global::Andrei15193.DtoMin.DTOHasAttributes)e.ModelElement);
					UpdateCompartments(elements, typeof(global::Andrei15193.DtoMin.DTOCompartmentShape), "AttributesCompartment", repaintOnly);
				}
			}
			
			#region static DomainPath traversal methods to get the list of compartments to update
			internal static global::System.Collections.ICollection GetDTOForDTOCompartmentShapeAttributesCompartment(global::Andrei15193.DtoMin.DTOHasAttributes root)
			{
				// Segment 0
				global::Andrei15193.DtoMin.DTO result = root.Attributes;
				if ( result == null ) return new DslModeling::ModelElement[0];
				return new DslModeling::ModelElement[] {result};
			}
			internal static global::System.Collections.ICollection GetDTOForDTOCompartmentShapeAttributesCompartmentFromPropertyElement(global::Andrei15193.DtoMin.DTOAttribute root)
			{
				// Segment 0
				global::Andrei15193.DtoMin.DTOHasAttributes result = global::Andrei15193.DtoMin.DTOHasAttributes.GetLinkToContainer(root);
				if ( result == null ) return new DslModeling::ModelElement[0];
				return new DslModeling::ModelElement[] {result};
			}
			#endregion
		...
		internal sealed class CompartmentItemDeleteRule : DslModeling::DeleteRule
		{
			...
			internal static void ElementDeleted(DslModeling::ElementDeletedEventArgs e, bool repaintOnly)
			{
				...
				if(e.ModelElement is global::Andrei15193.DtoMin.DTOHasAttributes)
				{
					global::System.Collections.ICollection elements = CompartmentItemAddRule.GetDTOForDTOCompartmentShapeAttributesCompartment((global::Andrei15193.DtoMin.DTOHasAttributes)e.ModelElement);
					CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::Andrei15193.DtoMin.DTOCompartmentShape), "AttributesCompartment", repaintOnly);
				}
			}
		}
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::Andrei15193.DtoMin.DTOAttribute), FireTime=DslModeling::TimeToFire.TopLevelCommit, InitiallyDisabled=true)]
		internal sealed class CompartmentItemChangeRule : DslModeling::ChangeRule 
		{
			...
			{
				if(e==null) throw new global::System.ArgumentNullException("e");
				if(e.ModelElement is global::Andrei15193.DtoMin.DTOAttribute && e.DomainProperty.Id == global::Andrei15193.DtoMin.DTOAttribute.NameDomainPropertyId)
				{
					global::System.Collections.ICollection elements = CompartmentItemAddRule.GetDTOForDTOCompartmentShapeAttributesCompartmentFromPropertyElement((global::Andrei15193.DtoMin.DTOAttribute)e.ModelElement);
					global::System.Collections.ArrayList list = new global::System.Collections.ArrayList(elements.Count);
					foreach(DslModeling::ModelElement element in elements)
					{
						global::System.Collections.ICollection rootElements  = CompartmentItemAddRule.GetDTOForDTOCompartmentShapeAttributesCompartment((global::Andrei15193.DtoMin.DTOHasAttributes)element);
						list.AddRange(rootElements);
					}
					CompartmentItemAddRule.UpdateCompartments(list, typeof(global::Andrei15193.DtoMin.DTOCompartmentShape), "AttributesCompartment", repaintOnly);
				}
			}
		}
		...
		internal sealed class CompartmentItemRolePlayerChangeRule : DslModeling::RolePlayerChangeRule 
		{
			...
			{
				if(e==null) throw new global::System.ArgumentNullException("e");
				if(typeof(global::Andrei15193.DtoMin.DTOHasAttributes).IsAssignableFrom(e.DomainRelationship.ImplementationClass))
				{
					if(e.DomainRole.IsSource)
					{
						//global::System.Collections.IEnumerable oldElements = CompartmentItemAddRule.GetDTOForDTOCompartmentShapeAttributesCompartmentFromLastLink((global::Andrei15193.DtoMin.DTOHasAttributes)e.OldRolePlayer);
						//foreach(DslModeling::ModelElement element in oldElements)
						//{
						//	DslModeling::LinkedElementCollection<DslDiagrams::PresentationElement> pels = DslDiagrams::PresentationViewsSubject.GetPresentation(element);
						//	foreach(DslDiagrams::PresentationElement pel in pels)
						//	{
						//		global::Andrei15193.DtoMin.DTOCompartmentShape compartmentShape = pel as global::Andrei15193.DtoMin.DTOCompartmentShape;
						...
						global::System.Collections.IEnumerable elements = CompartmentItemAddRule.GetDTOForDTOCompartmentShapeAttributesCompartment((global::Andrei15193.DtoMin.DTOHasAttributes)e.ElementLink);
						CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::Andrei15193.DtoMin.DTOCompartmentShape), "AttributesCompartment", repaintOnly);
					}
				}
			}
		...
		internal sealed class CompartmentItemRolePlayerPositionChangeRule : DslModeling::RolePlayerPositionChangeRule 
		{
			...
			internal static void RolePlayerPositionChanged(DslModeling::RolePlayerOrderChangedEventArgs e, bool repaintOnly)
			{
				...
				if(typeof(global::Andrei15193.DtoMin.DTOHasAttributes).IsAssignableFrom(e.DomainRelationship.ImplementationClass))
				{
					...
					{
						global::System.Collections.IEnumerable elements = CompartmentItemAddRule.GetDTOForDTOCompartmentShapeAttributesCompartment((global::Andrei15193.DtoMin.DTOHasAttributes)e.CounterpartRolePlayer);
						CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::Andrei15193.DtoMin.DTOCompartmentShape), "AttributesCompartment", repaintOnly);
					}
				}
			}
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::Andrei15193.DtoMin.DtoMinDiagram diagram = linkShape.Diagram as global::Andrei15193.DtoMin.DtoMinDiagram;
						if (diagram != null)
						{
