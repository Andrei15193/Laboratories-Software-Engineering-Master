...
{
    public class ExpenseXmlFileRepository
        : ExpenseXmlRepository
    {
        private readonly string _fileName;

        public ExpenseXmlFileRepository(string fileName, IExpenseCategoryRepository expenseCategoryRepository)
